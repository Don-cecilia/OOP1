...
int main()
{
	Rectangle rect(10,5);//initializing variables
	...
	rect = Rectangle(20,10);//reinitializing the members-> rectangle 2
	rect.compute();
...
Rectangle::Rectangle (double wid, double len)//parameterized constructor
{
	width = wid;
	length = len;
}
